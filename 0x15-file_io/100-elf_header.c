 ...
 * @e_type: The ELF type.
 * @e_ident: The pointer to an array containing ELF class.
 */
void print_type(unsigned int e_type, unsigned char *e_ident)
{
 ...
 *
 * Description: If the file cannot be closed - the exit code is 98.
 */
void close_elf(int elf)
{
	if (close(elf) == -1)
...
/**
 * main - This will display information contained in the
